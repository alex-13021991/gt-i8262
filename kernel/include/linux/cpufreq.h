...
#define MIN_FREQ_LIMIT		get_min_freq()

#if defined(CONFIG_MACH_ROY)
#define MIN_TOUCH_LIMIT	700800
#else
#define MIN_TOUCH_LIMIT	480000
#endif
#define MAX_UNICPU_LIMIT	700800
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_SMARTASS2)
